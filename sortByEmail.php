          ...
          try {
            ...
            if($con->connect_errno != 0) {
              throw new Exception(mysqli_connect_errno());
                ...
                $sql1 = "SELECT id, fldFirstName, fldLastName, fldEmail, fldBirthDate, fldSex FROM tbl_users ORDER BY fldEmail DESC LIMIT 18";
                ...
                if ($result->num_rows > 0) {
                  ...
                  <th><a href='sortByEmailAsc.php'>Email <i class='fa fa-sort-up'></i></a></th>
