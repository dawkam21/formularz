          ...
          try {
            ...
            if($con->connect_errno != 0) {
              throw new Exception(mysqli_connect_errno());
                ...
                $sql1 = "SELECT id, fldFirstName, fldLastName, fldEmail, fldBirthDate, fldSex FROM tbl_users ORDER BY id DESC LIMIT 18";
                ...
                if ($result->num_rows > 0) {
                  ...
                  echo "<tbody>
                  <tr>
                  <th style='padding: 2px; width: 8%;'><a href='sortByIdAsc.php'>id <i class='fa fa-sort-up'></i></th>
