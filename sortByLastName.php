          ...
          try {
            $con = new mysqli($HOSTNAME, $USERNAME, $PASSWORD, $DATABASE);
              ...
              if($con->connect_errno != 0) {
                ...
                $sql1 = "SELECT id, fldFirstName, fldLastName, fldEmail, fldBirthDate, fldSex FROM tbl_users ORDER BY fldLastName DESC LIMIT 10";
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    echo "<tbody>
                            <tr>
                              ...
                              <th style='width: 25%;'><a href='sortbyLastNameAsc.php'>Nazwisko <i class='fa fa-sort-up'></i></a></th>
